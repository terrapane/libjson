...
STF_TEST(JSONArray, InitializerList4)
{
    ...
    const JSONArray array({ 1, {{ {"key1", "a"}, {"key2", "b"} }}, 2 });
...
STF_TEST(JSONArray, ToString)
{
    ...
    const std::string result = array.ToString();
...
STF_TEST(JSONArray, Equality)
{
    ...
    const JSONArray array1({1, {{{"Key1", "Value1"}, {"Key2", "Value2"}}}, 2});
    const JSONArray array2({1, {{{"Key2", "Value2"}, {"Key1", "Value1"}}}, 2});
...
STF_TEST(JSONArray, Inequality)
{
    // This will initialize JSONArray objects holding a few elements
    const JSONArray array1({1, {{{"Key1", "Value1"}, {"Key2", "Value2"}}}, 2});
    const JSONArray array2({2, {{{"Key2", "Value2"}, {"Key1", "Value1"}}}, 1});
